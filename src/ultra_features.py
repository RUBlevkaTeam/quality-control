"""Deterministic text and rule features for the ultra classifier.

The functions in this module deliberately avoid optional ML dependencies.  They
are shared by the offline trainer, inference code and explanation generator so
that training and submission preprocessing cannot silently drift apart.
"""
